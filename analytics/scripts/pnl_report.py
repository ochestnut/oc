...
def pnl_report(
    ...
    risk_offset_position: Optional[pd.Series] = None,
    ...
    fills = load_fills(book, start, end, chunk_minutes=chunk_minutes, max_workers=max_workers)
    ...
    position = load_position(book, start, end, chunk_minutes=chunk_minutes, max_workers=max_workers)
    position = position[
    ...
    return decompose_pnl(
        ...
        risk_offset_position=risk_offset_position,
        perf=perf,
    )